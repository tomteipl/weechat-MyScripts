...
* ***X11notify.py*** - sends a notification to the X11 desktop using `notify-send` when a highlighted message is received.
...
2. **/autocommands del <number/string>** - deletes command from the list. You can use /autocommands list to see the numbers or tap TAB for auto completion.
